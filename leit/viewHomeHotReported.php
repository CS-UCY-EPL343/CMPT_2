...
$sql = "SELECT  DateTime, name, surname, email, age, sex , complaintFor, WebsiteName, platformname, typeofcomplaint,details FROM reportedHotLine where id= $_POST[koko] ";
...
<a href="/leit/operatorbreported.php" class="button"  style="background-color: #595352; width: 12%;" id="back"><span id="backk">Πίσω</span></a>
                             <a    href="/leit/deleteHotLineReported.php"  onclick="return confirm('Are you sure?')" class="button" style="background-color: #890916; width: 13%;" id="delete"><span id="deletee">Διαγραφή</span></a>
                              <a    href="/leit/sendBackReported.php"  onclick="return confirm('Are you sure?')" class="button" style="background-color: #47d138; width: 13%;" id="delete"><span id="deletee">Επιστροφή</span></a>
