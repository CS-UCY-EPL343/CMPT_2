...
<body onload="contact_form.reset();">
  ...
  <div class="container">
    ...
    <form class="well form-horizontal" action="action.php" method="post"  id="contact_form" data-toggle="validator">
<fieldset>
...
<!-- sxolia
 ...
 <div class="form-group">
  <label class="col-md-4 control-label">Λεπτομέρειες</label>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
          <textarea type="text" class="form-control" name="comment"  placeholder="Λεπτομέρειες" ></textarea>
  </div>
  </div>
</div>
 ...
 <!-- Text input-->
  ...
  <div class="form-group" id="clasic">

  <label class="col-md-4 control-label">'Ονομα</label>  
  <div class="col-md-4 inputGroupContainer">
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="first_name" placeholder="Ονομα" autocomplete=off class="form-control"  type="text" id="first">
    </div>
  </div>
</div>
<!-- maxlength="25" -->
...
<script src='http://cdnjs.cloudflare.com/ajax/libs/bootstrap-validator/0.4.5/js/bootstrapvalidator.min.js'></script>
 ...
 function myFunction() {
    ...
    if (x=="Ιστσελίδα"){
       // $("#VoIP").attr("name","platnameb");
      // document.getElementById("clasic").className = "ael";
