...
window.setInterval(createjson, 200);
     function createjson(){
        ...
        xmlhttp.open("GET","createjsonHelpLineClosed.php",true);
        xmlhttp.send();
    }
...
function post(test) {
    ...
    form.setAttribute("method", method);
     form.setAttribute("action", "showHelpLineDetailsClosed.php");
    ...
    $(document).ready(function () {
        $.getJSON("empdatahelplineclosed.json", function (data) {
         ...
         //  table.id='tab';
            ...
            for (var i = 0; i < col.length; i++) {
                ...
                else if (col[i]=="datetimeclosed"){
                    vali="Ημερ/νία Ολοκλήρωσης";
                }
                th.innerHTML = vali;
                tr.appendChild(th);
            }
