...
$sql = "SELECT  DateTime, name, surname, email, age, sex , complaintFor, WebsiteName, platformname, typeofcomplaint,details FROM hotlinecomplaint where id= $_POST[koko] ";
...
<a href="/leit/despHotLine.php" class="button"  style="background-color: #595352; width: 12%;" id="back"><span id="backk">Back</span></a>
