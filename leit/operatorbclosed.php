...
window.setInterval(createjson, 300);
     function createjson(){
        ...
        xmlhttp.open("GET","createjsonHotLineClosed.php",true);
        xmlhttp.send();
    }
...
<div class="dropdown">
  <span class="dropbtn" style="color: #e9ac09">Καταγγελίες Hot Line</span>
...
function post(test) {
    ...
    form.setAttribute("method", method);
     form.setAttribute("action", "viewHomeHot.php");
    ...
    $(document).ready(function () {
        $.getJSON("empdatahotlineclosed.json", function (data) {
         ...
         //  table.id='tab';
            ...
            for (var i = 0; i < col.length; i++) {
                ...
                else if (col[i]=="complaintdate"){
                    vali="Ημερ/νία Καταγγελίας";
                }
                else if (col[i]=="sendToPoliceDate"){
                    vali="Ημερ/νία Αποστολής Σε Αστυνομία";
                }
                th.innerHTML = vali;
                tr.appendChild(th);
            }
